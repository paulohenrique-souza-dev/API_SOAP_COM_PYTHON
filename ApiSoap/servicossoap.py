...
from models import (
    Produto, Estoque, Vendedor, Cliente,
    Categoria, Fornecedor, Pedido, ItemPedido
)
...
class ServicosApiSoap(ServiceBase):
    ...
    def CreateFornecedor(ctx, nome_fornecedor, cidade, estado):
        return create_item("fornecedores", {
    ...
    def UpdateFornecedor(ctx, id_fornecedor, nome_fornecedor, cidade, estado):
        return update_item("fornecedores", id_fornecedor, {
            "nome_fornecedor": nome_fornecedor,
            "cidade": cidade,
            "estado": estado
        })
    ...
    def GetCategorias(ctx):
        for item in get_results("categorias"):
            yield Categoria(
                ...
                nome_categoria=item.get("nome_categoria")
            )
    ...
    @rpc(Unicode, Unicode, Date, Unicode, _returns=ResponseMessage)
    ...
    @rpc(Integer, Unicode, Unicode, Date, Unicode, _returns=ResponseMessage)
    def UpdateCliente(ctx, id_cliente, nome, cidade, data_cadastro, tipo_cliente):
        return update_item("cliente", id_cliente, {
            "nome": nome,
            "cidade": cidade,
            "data_cadastro": data_cadastro,
            "tipo_cliente": tipo_cliente
    ...
    @rpc(Unicode, Unicode, Decimal, Date, _returns=ResponseMessage)
    def CreateVendedor(ctx, nome, regiao, salario, data_admissao):
        return create_item("vendedores", {
            "nome": nome,
            "regiao": regiao,
            "salario": salario,
    ...
    @rpc(Integer, Unicode, Unicode, Decimal, Date, _returns=ResponseMessage)
    def UpdateVendedor(ctx, id_vendedor, nome, regiao, salario, data_admissao):
        return update_item("vendedores", id_vendedor, {
            "nome": nome,
            "regiao": regiao,
            "salario": salario,
            "data_admissao": data_admissao
    ...
    @rpc(Unicode, Decimal, Decimal, Integer, Integer, _returns=ResponseMessage)
    ...
    @rpc(Integer, Unicode, Decimal, Decimal, Integer, Integer, _returns=ResponseMessage)
    def UpdateProduto(ctx, id_produto, nome_produto, preco, custo, id_categoria, id_fornecedor):
        return update_item("produto", id_produto, {
            "nome_produto": nome_produto,
            "preco": preco,
            "custo": custo,
            "id_categoria": id_categoria,
    ...
    def GetEstoque(ctx):
        for item in get_results("estoque"):
            yield Estoque(
                id_estoque=item.get("id_estoque"),
    ...
    @rpc(Decimal, Decimal, Date, Integer, _returns=ResponseMessage)
    def CreateEstoque(ctx, quantidade, estoque_minimo, data_atualizacao, id_produto):
        return create_item("estoque", {
    ...
    @rpc(Integer, Integer, Integer, Date, Integer, _returns=ResponseMessage)
    def UpdateEstoque(ctx, id_estoque, quantidade, estoque_minimo, data_atualizacao, id_produto):
        return update_item("estoque", id_estoque, {
            "quantidade": quantidade,
            "estoque_minimo": estoque_minimo,
            "data_atualizacao": data_atualizacao,
            "id_produto": id_produto
    ...
    @rpc(Date, Unicode, Integer, Integer, _returns=ResponseMessage)
    def CreatePedido(ctx, data_pedido, status_pedido, id_cliente, id_vendedor):
        return create_item("pedidos", {
    ...
    @rpc(Integer, Date, Unicode, Integer, Integer, _returns=ResponseMessage)
    def UpdatePedido(ctx, id_pedido, data_pedido, status_pedido, id_cliente, id_vendedor):
        return update_item("pedidos", id_pedido, {
            "data_pedido": data_pedido,
            "status_pedido": status_pedido,
            "id_cliente": id_cliente,
            "id_vendedor": id_vendedor
    ...
    @rpc(Integer, Decimal, Integer, Integer, _returns=ResponseMessage)
    def CreateItemPedido(ctx, quantidade, valor_unitario, id_pedido, id_produto):
        return create_item("itens-pedido", {
            "quantidade": quantidade,
    ...
    @rpc(Integer, Integer, Decimal, Integer, Integer, _returns=ResponseMessage)
    def UpdateItemPedido(ctx, id_item, quantidade, valor_unitario, id_pedido, id_produto):
        return update_item("itens-pedido", id_item, {
            "quantidade": quantidade,
            "valor_unitario": valor_unitario,
            "id_pedido": id_pedido,
            "id_produto": id_produto
